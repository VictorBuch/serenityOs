...
This guide covers installing Windows VST plugins (Amplitube 5) with copy protection (IK Product Manager) on NixOS with yabridge.

## Step-by-Step Installation

### 1. Install IK Product Manager (for Amplitube 5)
...
1. Install IK Product Manager (for IK Multimedia plugins)
2. Authorize plugins through respective managers
3. Re-sync yabridge
