...
{
  # Enable OpenCode with default MCP server configurations
  home.cli.opencode = {
    enable = true;
    ...
    # Custom agents (feature-goal-definer is included by default)
    agents = {
      # Default agent is already included, shown here for reference
      feature-goal-definer = {
        description = "Use this agent when you need to establish clear, actionable goals for a new feature or product enhancement";
        mode = "subagent";
        content = ''
